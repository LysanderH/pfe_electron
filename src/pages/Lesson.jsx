...
export default function Lesson() {
  ...
  const addExercise = (exercise) => {
    let copyExercises = exercises.slice();
    if (copyExercises.some((copyExercise) => copyExercise.id === exercise.id)) {
      copyExercises = copyExercises.filter((obj) => {
        return obj.id !== exercise.id;
      });
    } else {
